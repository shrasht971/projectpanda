    ...
    <nav className="bg-teal-800 text-white py-4">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4 items-center">
          ...
          <Link to="/signin/student" className="hover:text-gray-300 bg-gray-900 text-white px-3 py-1 rounded-md">Sign In Student</Link>
          <Link to="/signin/teacher" className="hover:text-gray-300 bg-gray-900 text-white px-3 py-1 rounded-md">Sign In Teacher</Link>
        </div>
